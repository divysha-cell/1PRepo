# FireEye Helix - Alerts Connector Instance



Integration: FireEyeHelix

Integration Version: 19

Device Product Field: Product Name

Event Name Field: class
### Parameters
...
|API Root|API Root of the FireEye Helix instance. Example: https://helix.eu.fireeye.com/helix/id/aaaqsj477/|True|https://helix.eu.fireeye.com/helix/id/{id}/|
|API Token|API Token of the FireEye Helix account.|True|*****|
|Server Timezone|Specify which timezone is set on the FireEye Helix server in regards to UTC. For example, +1, -1, etc. If nothing is specified, the connector will use UTC as a default timezone.|False|dummy_value|
|Lowest Risk To Fetch|Lowest risk that will be used to fetch Alert. Possible values: Low, Medium, High, Critical.|True|Medium|
...
|Verify SSL|If enabled, verify the SSL certificate for the connection to the FireEye Helix server is valid.|False|false|
