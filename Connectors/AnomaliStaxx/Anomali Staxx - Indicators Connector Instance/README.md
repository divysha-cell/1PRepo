# Anomali Staxx - Indicators Connector Instance
...
|Username|Username of the Anomali Staxx account.|True|dummy_value|
|Password|Password of the Anomali Staxx account.|True|*****|
|Server Timezone|Specify which timezone is set on the Anomali Staxx server in regards to UTC. For example, +1, -1, etc. If nothing is specified, the connector will use UTC as a default timezone.|False|dummy_value|
