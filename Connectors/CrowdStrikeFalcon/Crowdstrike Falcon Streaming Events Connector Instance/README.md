# Crowdstrike Falcon Streaming Events Connector Instance
...
|Environment Regex Pattern|A regex pattern to run on the value found in the "Environment Field Name" field.|False|dummy_value|
|API Root|API root of the Crowdstrike instance|False|https://api.crowdstrike.com|
|Client ID|Client ID for Crowdstrike API|True|dummy_value|
