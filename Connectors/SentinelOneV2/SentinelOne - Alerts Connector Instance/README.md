# SentinelOne - Alerts Connector Instance
...
|API Root|Address of SentinelOne API root.|True|dummy_value|
...
|Lowest Severity To Fetch|Lowest severity of the alerts to fetch. If nothing is provided, the connector will ingest alerts with all severities. Possible Values: Info, Low, Medium, High, Critical.|False|dummy_value|
