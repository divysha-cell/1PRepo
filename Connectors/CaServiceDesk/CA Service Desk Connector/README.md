...
|----|-----------|------------|-----|
|API Root|e.g. http://x.x.x.x:8080|True|q|
|Username|Username|True|q|
...
|List Of Users To Ignore|Comma separated. Filter incidents by users to ignore|False|q|
|Categories List|Filter incidents by categories|False||
|Groups List|Filter incidents by groups|False||
