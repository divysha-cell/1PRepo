# Azure Security Center - Security Alerts Connector Instance
...
|Client ID|Client ID of the Microsoft Azure application. |True|dummy_value|
|Client Secret|Client Secret of the Microsoft Azure application.|True|*****|
|Username|Username of the Microsoft Azure account.|False|dummy_value|
|Password|Password of the Microsoft Azure account.|False|*****|
|Subscription ID|Subscription ID of the Microsoft Azure application.|True|dummy_value|
|Tenant ID|Tenant ID of the Microsoft Azure application.|True|dummy_value|
