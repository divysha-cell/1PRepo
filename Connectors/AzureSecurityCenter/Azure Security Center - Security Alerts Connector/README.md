...
|Client ID|Client ID of the Microsoft Azure application. |True|q|
...
|Subscription ID|Subscription ID of the Microsoft Azure application.|True|q|
|Tenant ID|Tenant ID of the Microsoft Azure application.|True|q|
