# Arcsight ESM Connector Instance
...
|Secondary Device Product Field|Secondary field for Device Product|False|dummy_value|
|Alert Custom Fields Names|Additional fields that should be added to Siemplify Alert. Example: source_address|False|dummy_value|
