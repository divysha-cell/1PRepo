...
|----|------|-----------|
|1New Playbook|Default||
|2New Playbook|Default||
...
|Nw Playbook|Default||
|Carbon Black Cloud Remediation|Siemplify Use Cases||
|Copy of Carbon Black Cloud Remediation - 1|Siemplify Use Cases||
