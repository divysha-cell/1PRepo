...
|----|-----------|-----------|----|------------|
|SSH Root|SSH root of the Blue Coat ProxySG instance.|True|String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Create Insight|If enabled, action will create an insight containing all of the retrieved information about the entity.|False|None||
