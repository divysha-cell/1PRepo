...
def main():
    ...
    new_password = extract_action_param(
        siemplify, param_name="New Password", is_mandatory=True, input_type=str
    )
        ...
        if target_entities:
            ...
            if failed_entities:
                if incorrect_password:
                    output_message += (
                        "Failed to execute action 'Set User Password' - either you don't have an SSL "
