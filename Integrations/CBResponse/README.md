...
|CA Certificate File|CA certificate file to use with the verify_ssl option. Certificate file should be specified as a Base64-encoded string.||String||
...
|Environment Field Name|The name of the environment's field.||String||
|List Type|Can be whitelist or blacklist.||String||
|List Operator|Can be 'exact', 'start with', 'ends with' or 'contains'.||String||
|List Fields|List of fields, comma separated.||String||
|CA Certificate File|CA certificate file to use with the verify_ssl option. Certificate file should be specified as a Base64-encoded string.||String||
|Verify SSL|Whether to verify ssl certificate on connection or not||Boolean|false|
