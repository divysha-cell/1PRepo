...
|----|-----------|-----------|----|------------|
|API Root|None|True|String|https://<service_address>/tecloud/api/<version>/file|
...
|Enable Threat Emulation feature|If enabled, threat emulation feature will be enabled for the upload. By default, if no features are selected, threat emulation will be used.|False|Boolean|True|
|Enable AntiVirus feature|If enabled, antivirus feature will be enabled for the upload. By default, if no features are selected, threat emulation will be used.|False|Boolean|False|
|Enable Threat Extraction feature|If enabled, threat extraction feature will be enabled for the upload. By default, if no features are selected, threat emulation will be used.|False|Boolean|False|
