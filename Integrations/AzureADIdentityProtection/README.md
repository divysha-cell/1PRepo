...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Create Insights|If enabled, action will create an insight containing all of the retrieved information about the entity.|False|None||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|State|Specify the state for the users.|False|None||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Verify SSL|If enabled, verify the SSL certificate for the connection to the Azure AD Identity Protection server is valid.|False|None|true|
...
|API Root|API root of the Azure AD Identity Protection instance.|True|None|https://graph.microsoft.com|
|Login API Root|Login API root of the Azure AD Identity Protection instance.|False|None|https://login.microsoftonline.com|
|Tenant ID|Tenant ID of the Azure AD Identity Protection account.|True|None||
|Client ID|Client ID of the Azure AD Identity Protection account.|True|None||
|Client Secret|Client Secret of the Azure AD Identity Protection account.|True|None||
|Lowest Risk Level To Fetch|Lowest risk that needs to be used to fetch alerts. Possible values: Low, Medium, High. If nothing is specified, the connector will ingest risk detections with all risk levels.|False|None||
...
|Max Alerts To Fetch|How many alerts to process per one connector iteration. Default: 100.|False|None|100|
